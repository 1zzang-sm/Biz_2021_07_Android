...
1. 화면에 UI를 표현하는 일
    *.xml 파일을 읽어서 화면을 구현
    event Handling 수행
2. Activity 이름짓기
    Activity class는 UI 관련된 파일을 1개 이상 연결한다
    이름Activity.java 라는 이름으로 작성하고
    activity_이름.xml 라는 이름으로 화면 구현 xml 파일을 작성한다.
 */
public class MainActivity extends AppCompatActivity {
    ...
    작성하고 있는 App이 안드로이드 phone에서 생성될때
    작동하는 method
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        xmx view에 설정된 view content를 java code에서 사용하기 위하여
        import 하는 절차
         */
        ...
        // click event를 처리할 event handler 선언
        // interface를 사용하여 직접 객체를 생성하는 방법
        // 정통자바에서는 interface를 implement 한 class를 작성하고
        // class를 사용하여 객체를 선언(생성, 초기화)하였는데
        ...
        View.OnClickListener btn_click = new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(v.getId() == R.id.btn_login) {
                     ...
                     * Activity의 super parent class 이다.
                     *
                     * 새로운 Activity를 보여주는 절차
                     * 1. Intent class를 사용하여 인텐트 생성
